...
Each tuple contains three elements -- first name, last name, and distance to travel.
(The first two are strings, and the third is a float.)  We will return a list
of strings, sorted by last name and then first name.
"""
    output = []
